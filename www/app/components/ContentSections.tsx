...
const Parameter = ({
  ...
  <div className="flex gap-4 py-2.5">
    ...
    <div className="flex-1">
      ...
      <p className="text-[14px] text-[#666] dark:text-[#999] mt-0.5 leading-relaxed">{description}</p>
      {defaultValue && (
  ...
  return (
    <div>
      ...
      >
        ...
        <code className="text-[14px] font-mono font-normal text-[#333] dark:text-[#eee]">{name}</code>
      </button>
      {isOpen && (
        <div className="pt-3 pb-6 ml-[22px]">
          <MethodSignature>{signature}</MethodSignature>
          <p className="text-[14px] text-[#666] dark:text-[#999] mt-3 leading-relaxed">{description}</p>
...
const TypeDefinition = ({ name, definition, description }: { name: string; definition: string; description: string }) => (
  <div className="py-4">
    <h4 className="text-[16px] font-medium text-[#333] dark:text-[#eee] mb-2">{name}</h4>
    <p className="text-[14px] text-[#666] dark:text-[#999] mb-4 leading-relaxed">{description}</p>
...
const DelegateMethod = ({
  ...
  <div className="py-3">
    <code className="text-[13px] font-mono text-[#e06c75]">{name}</code>
    <p className="text-[14px] text-[#666] dark:text-[#999] mt-1.5 leading-relaxed">{description}</p>
  ...
  return (
    <div className="lg:grid lg:grid-cols-[1fr_auto] lg:gap-16 py-16">
      ...
      <div className="space-y-24 max-w-[900px]">
        ...
        <section id="features">
          <div className="mb-12">
            <p className="font-mono text-[14px] text-[#999] dark:text-[#666] mb-2">### Features</p>
...
controller.focusPane(paneId)`}
        ...
        <section id="api-reference">
          <div className="mb-12">
            <p className="font-mono text-[14px] text-[#999] dark:text-[#666] mb-2">### Reference</p>
            <h2 className="text-[32px] font-semibold text-[#333] dark:text-[#eee]">
              Reference
            </h2>
...
let controller = BonsplitController(configuration: config)`}</CodeBlock>
              ...
              <div className="overflow-x-auto bg-[#f8f9fa] dark:bg-[#111] rounded-md">
                <table className="w-full text-[13px]">
                  <thead>
                    <tr>
                      <th className="text-left py-2.5 px-4 font-medium text-[#666] dark:text-[#999]">Mode</th>
                      <th className="text-left py-2.5 px-4 font-medium text-[#666] dark:text-[#999]">Memory</th>
                      <th className="text-left py-2.5 px-4 font-medium text-[#666] dark:text-[#999]">State</th>
                      <th className="text-left py-2.5 px-4 font-medium text-[#666] dark:text-[#999]">Use Case</th>
                    </tr>
                  </thead>
            ...
            {sections.map((section, index) => {
              ...
              return (
                <li key={section.id} className="flex">
                  <span className="text-[#ccc] dark:text-[#444] select-none whitespace-pre">{prefix}</span>
                  <a
                    href={href}
